...
../run_RF2NA.sh rna_pred 0 rna_binding_protein.fa R:RNA.fa
# run Protein/DNA prediction
../run_RF2NA.sh dna_pred 0 dna_binding_protein.fa D:DNA.fa
```
### Inputs
* The first argument to the script is the output folder
* The second argument to the script is an integer indicating whether to use single-sequence mode (`1`) or not (`0`)
